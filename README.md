...
And the primary tool is foot and dbclient for actual control and data transfer between the slave units - wpa_supplicant is used to create a AP/hotspot and a STA device on the same phy for example.
